...
import com.example.iot.Device.{Passivate, RecordTemperature, TemperatureRecorded}
import com.example.iot.DeviceManager.{DeviceRegistered, ReplyDeviceList, RequestAllTemperatures, RequestDeviceList, RequestTrackDevice, RespondAllTemperatures, Temperature, TemperatureNotAvailable}
